...
mapped_closeness = {
    node_type_list[i]: centrality for i, centrality in closeness_centrality.items()
}
mapped_betweenness = {
    node_type_list[i]: centrality for i, centrality in betweenness_centrality.items()
}
